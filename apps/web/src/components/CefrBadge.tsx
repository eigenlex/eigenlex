...
// Deliberately quiet: a gloss can carry six of these, and they annotate the terms rather
// than compete with them. Spacing is a margin, not a space character, so the line's text
// content stays the gloss itself ("water, aqua") — for copy, and for the tests that read it.
const BADGE =
 ...
 * aloud, and the alternative, hidden text, would ride along into anything copied out of
 * the gloss. Its children being presentational is what keeps "A1" from being read twice.
 */
